...
public class AlarmHandlerTest extends AndroidTestCase {
    ...
    public void test_should_return_this_coming_noon_when_given_time_is_morning() {
    ...
    public void test_should_return_the_next_morning_when_given_time_passed_morning() {

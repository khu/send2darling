...
public class AlarmTimerTest {
    ...
    public void should_return_this_coming_noon_when_given_time_is_morning() {
        ...
        assertThat(new AlarmTimer().morning(dateTime), is(new DateTime(2010, 12, 12, 8, 0, 0)));
    }
    ...
    public void should_return_the_next_morning_when_given_time_passed_morning() {
        ...
        assertThat(new AlarmTimer().morning(dateTime), is(new DateTime(2010, 12, 13, 8, 0, 0)));
    }
